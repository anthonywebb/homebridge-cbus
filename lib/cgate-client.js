...
CBusClient.prototype.setBrightness = function (netId, level, callback, delay, comment) {
...
CBusClient.prototype._buildSetCommandString = function (netId, command, level, duration, comment) {
