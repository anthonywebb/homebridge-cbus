...
function _extractUnits(network, projectName, result) {
	_arrayize(network.unit).forEach(srcUnit => {
		...
		unit.groups = _extractGroupAddresses(unit, netId.toString());
